...
BLOG_AUTHOR = "Frank Reininghaus"  # (translatable)
BLOG_TITLE = "Frank Reininghaus"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://freininghaus.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://freininghaus.github.io/"
BLOG_EMAIL = "frank78ac@googlemail.com"
BLOG_DESCRIPTION = "Frank Reininghaus' website"  # (translatable)
